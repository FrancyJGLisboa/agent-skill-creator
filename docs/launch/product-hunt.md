...
Launch 12:01am PT for a full day on the leaderboard. Have the GIF + 3–4 gallery
images ready (hero diagram, demo GIF, an example skill's output, the comparison
...
## Tagline (≤60 chars)
Pick one:
- `Turn any workflow into a cross-platform agent skill`
- `Describe a workflow → a validated skill on 17 AI tools`
- `Agent skills for Claude, Cursor & 15 more — from plain English`
...
## Gallery (order)
1. Hero diagram (`assets/hero.svg` → PNG)
2. Demo GIF (`assets/demo.gif`)
3. An example skill's output (e.g. weekly-crm-report summary JSON)
4. The "why this vs alternatives" comparison table
