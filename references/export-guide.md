...
**Version:** 6.0
**Purpose:** Complete guide to exporting agent-skills-platform skills for use across all Claude platforms

---

## 🎯 Overview

Skills created by agent-skills-platform are optimized for **Claude Code**, but can be exported for use across all Claude platforms:
...
After creating a skill, agent-skills-platform will prompt:
...
**Report issues:**
- GitHub Issues: [agent-skills-platform issues](https://github.com/FrancyJGLisboa/agent-skills-platform/issues)

---

**Generated by:** agent-skills-platform
