...
Skills created by agent-skills-platform output both **SKILL.md** (agentskills.io spec, ~15 tools) and **AGENTS.md** (AAIF-governed spec, ~15 tools) to maximize cross-tool reach. Together they cover 17 tools across 3 support tiers.
...
**Generated by:** agent-skills-platform v6.0
